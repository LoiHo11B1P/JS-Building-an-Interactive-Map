...
// Draw the 2nd Arrondissement                                          
const latlong = [[48.863368120198004, 2.3509079846928516],
...
let polygon = L.polygon(latlong, {color: 'blue'}).addTo(myMap);
myMap.fitBounds(polygon.getBounds());
// create red pin marker
// creating a custom pin to be use with our markers
let redPin = L.icon({
...
// adding ping to map layer using layerGroup
